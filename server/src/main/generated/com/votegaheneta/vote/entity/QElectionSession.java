...
public class QElectionSession extends EntityPathBase<ElectionSession> {
    ...
    public final ComparablePath<java.io.File> qrCode = createComparable("qrCode", java.io.File.class);

    public final com.votegaheneta.chat.entity.QSessionChatRoom sessionChatRoom;
    ...
    public QElectionSession(Class<? extends ElectionSession> type, PathMetadata metadata, PathInits inits) {
        ...
        this.sessionChatRoom = inits.isInitialized("sessionChatRoom") ? new com.votegaheneta.chat.entity.QSessionChatRoom(forProperty("sessionChatRoom"), inits.get("sessionChatRoom")) : null;
    }
