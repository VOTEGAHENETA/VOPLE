...
public class QVoteTeam extends EntityPathBase<VoteTeam> {
    ...
    public final com.votegaheneta.chat.entity.QTeamChatRoom teamChatRoom;
    ...
    public QVoteTeam(Class<? extends VoteTeam> type, PathMetadata metadata, PathInits inits) {
        ...
        this.teamChatRoom = inits.isInitialized("teamChatRoom") ? new com.votegaheneta.chat.entity.QTeamChatRoom(forProperty("teamChatRoom"), inits.get("teamChatRoom")) : null;
